  ...
  RSpec.describe AddCaseRequestor do
    ...
    let(:provider) do
      double Provider,
             firm_id: 19148,
             office_id: 137570,
             user_login_id: 4953649,
             contact_user_id: 4953649,
             supervisor_user_id: 7008010,
             fee_earner_contact_id: 4925152
    end
    ...
    describe 'XML request' do
      it 'generates the expected XML' do
        Timecop.freeze Time.new(2019, 4, 01, 16, 4, 57.039) do
          ...
          filename = '/Users/stephenrichards/Library/Preferences/RubyMine2018.3/scratches/scratch_4.xml'
